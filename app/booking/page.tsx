      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white flex items-center justify-center p-4">
        <div className="max-w-md w-full text-center">
          ...
          <div className="bg-blue-50 border-2 border-blue-200 rounded-xl p-4 mb-6">
            <p className="text-2xl font-mono font-bold text-[#0A1628]">{bookingNumber}</p>
          </div>
          ...
          <div className="bg-gray-50 rounded-xl p-4 mb-6 text-left space-y-2">
            ...
            <div className="flex items-start gap-2 text-sm text-gray-600">
              ...
              <a href={CLINIC_INFO.mapsUrl} target="_blank" rel="noopener noreferrer" className="hover:text-[#1B3A6B] transition-colors">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex gap-3">
              <Link href="/" className="flex-1">
                <button className="w-full px-4 py-2.5 border border-[#1B3A6B] text-[#1B3A6B] rounded-lg font-medium hover:bg-blue-50 transition-colors text-sm">
                  Kembali ke Beranda
                </button>
              </Link>
              <button
                ...
                className="flex-1 px-4 py-2.5 bg-[#1B3A6B] text-white rounded-lg font-medium hover:bg-[#0A1628] transition-colors text-sm"
              >
                Booking Lagi
              </button>
            </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white">
      ...
      <header className="bg-white border-b border-blue-100 px-4 py-4">
        <div className="container mx-auto max-w-4xl flex items-center gap-3">
          <Link href="/" className="flex items-center gap-2 text-[#0A1628] font-bold">
                ...
                <div className={`flex items-center gap-2 ${idx < STEPS.length - 1 ? "" : ""}`}>
                  ...
                  <span
                    className={`text-sm font-medium whitespace-nowrap hidden sm:block ${
                      step === s.number ? "text-[#0A1628]" : step > s.number ? "text-green-600" : "text-gray-400"
                    }`}
                  >
                    {s.label}
                  </span>
